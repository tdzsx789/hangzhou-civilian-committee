  ...
  return (
    <div className="App">
      ...
      <div style={{
        ...
        <Home onLearnMore={handleLearnMore} language={language} onToggleLanguage={handleToggleLanguage} />
      </div>
      <div style={{
        position: 'absolute',
        width: '100%',
        ...
        <Detail name="城市社区治理发展历程1" gallery="A馆" onBack={handleBack} isVisible={currentPage === 'detail'} language={language} />
      </div>
    </div>
  );
}
